  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700">
      <table className="w-full min-w-[1320px] table-fixed text-left text-xs">
        <thead className="bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200">
          <tr>
            <th className="sticky left-0 z-10 w-[360px] bg-slate-100 px-3 py-2 dark:bg-slate-800">Periodo evaluado</th>
        ...
        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
          {datos.map(row => {
            ...
            <tr key={row.descriptor} className="text-slate-700 dark:text-slate-300">
              <td className="sticky left-0 z-10 w-[360px] bg-white px-3 py-2 font-semibold dark:bg-slate-900">
                {row.descriptor}
