...
export default function NuevaTrasladoPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto">
      <section className="relative mb-6 overflow-hidden rounded-3xl bg-gradient-to-br from-[#0d2739] via-[#1a4e70] to-[#2b8ca8] px-5 py-5 shadow-lg shadow-cyan-950/15 md:px-7 md:py-6">
